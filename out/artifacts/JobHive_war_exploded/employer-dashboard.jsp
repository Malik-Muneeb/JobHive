...
<div class="container-fluid"
     style="background-image: url('images/login3-bg.jpeg');;background-size: cover;background-repeat: no-repeat;">
    <div class="container">
        <div class="row" id="vid-container-dashboard">
            <div class="col-sm-12" style="padding-top: 50px;"><br></br>
                <h1 style="font-size: 40px;color:white"> Employer Dashboard</h1>
            </div>
            <div class="col-sm-12 ">
                <h2 style="color:white">Welcome <span
                        style="color:#378CE8"><strong><%=session.getAttribute("userName")%></strong></span></h2>
            </div>
            ...
            <div class="col-sm-12 ">
                ...
                <div class="col-lg-6">
                    <div class="col-lg-11" id="employer-optn1">
                        <a href="post-job.jsp" class="employer-optns">
                            <center>
                ...
                <div class="col-lg-6">
                    <div class="col-lg-11 col-lg-offset-1" id="employer-optn2">
                        <a href="controller.jsp?action=postedJobs" class="employer-optns">
                            <center>
                                <span class="glyphicon glyphicon-eye-open btn-lg" style="font-size: 30px;"></span><br>
                                <h2>View All JOBS</h2>
                            </center>
