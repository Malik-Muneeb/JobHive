    ...
    <div class="container">
        <div class="row" id="vid-container-dashboard">
            <div class="col-sm-12" style="padding-top: 50px;"><br></br>
                <h1 style="font-size: 40px;"> Employee Details</h1>
            </div>
            <%
                String name=request.getParameter("name");
                Employee empObj=new Employee();
                empObj= new EmployeeDAO().getInfo(name);
            %>
            ...
            <div class="col-lg-12 col-sm-12 job-box">
                ...
                <div class="col-lg-10">
                    ...
                    <%=empObj.getEmail()%>
                    <h4><strong>First Name (User Name)</strong></h4>
                    <%=empObj.getFirstName()%>
                    <br><br>
                    <h4><strong>Full Employee Details</strong></h4>
                    <h5><strong>Last Name: </strong><%=empObj.getLastName()%>
                    </h5>
                    <h5><strong>Password: </strong><%=empObj.getPassword()%>
                    </h5>
                    <h5><strong>Date of Birth: </strong><%=empObj.getDob()%>
                    </h5>
                    <h5><strong>Contact: </strong><%=empObj.getContact()%>
                    </h5>
                    <h5><strong>Nationality: </strong><%=empObj.getNationality()%>
                    </h5>
                    <h5><strong>Gender: </strong><%=empObj.getGender()%>
                    </h5>
